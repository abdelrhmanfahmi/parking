            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void(0);" key="t-settings">{{__('messages.Settings')}}</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void(0);" key="t-question">{{__('messages.Services')}}</a></li>
                        <li><a href="javascript:void(0);" key="t-question">{{__('messages.Add Services')}}</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void(0);" key="t-task">{{__('messages.Why Steps')}}</a></li>
                        <li><a href="javascript:void(0);" key="t-task">{{__('messages.Add Why Steps')}}</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void(0);" key="t-receipt">{{__('messages.Benifits')}}</a></li>
                        <li><a href="javascript:void(0);" key="t-receipt">{{__('messages.Add Benifits')}}</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void(0);" key="t-question">{{__('messages.Sections')}}</a></li>
                        <li><a href="javascript:void(0);" key="t-question">{{__('messages.Add Sections')}}</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void(0);" key="t-packages">{{__('messages.Advantages')}}</a></li>
                        <li><a href="javascript:void(0);" key="t-packages">{{__('messages.Add Advantages')}}</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript:void(0);" key="t-question">{{__('messages.Questions')}}</a></li>
                        <li><a href="javascript:void(0);" key="t-question">{{__('messages.Add Question')}}</a></li>
                    </ul>
                </li>
